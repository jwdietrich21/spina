...
vellore$SPINA_GR <- SPINA.GR(vellore$Fasting.Insulin * Insulin.conversion.factor, vellore$Fasting.Glucose/Glucose.conversion.factor);
vellore$SPINA_GBeta <- SPINA.GBeta(vellore$Fasting.Insulin * Insulin.conversion.factor, vellore$Fasting.Glucose/Glucose.conversion.factor);
vellore$SPINA_DI <- vellore$SPINA_GBeta * vellore$SPINA_GR;
vellore$HOMA_Beta <- HOMA.Beta(vellore$Fasting.Insulin * Insulin.conversion.factor, vellore$Fasting.Glucose/Glucose.conversion.factor);
vellore$HOMA_IR <- HOMA.IR(vellore$Fasting.Insulin * Insulin.conversion.factor, vellore$Fasting.Glucose/Glucose.conversion.factor);
vellore$HOMA_IS <- HOMA.IS(vellore$Fasting.Insulin * Insulin.conversion.factor, vellore$Fasting.Glucose/Glucose.conversion.factor);
vellore$QUICKI_Score <- QUICKI(vellore$Fasting.Insulin * Insulin.conversion.factor, vellore$Fasting.Glucose/Glucose.conversion.factor);

res <- file.choose(new = TRUE);
write.csv(vellore, file = res);
