...
procedure ShowResult(TSH_String, T4_String, T3_String: Str255; theResult: string);
...
procedure THauptschirm.CenterItemClick(Sender: TObject);
begin
  FormStyle := fsNormal;
...
procedure THauptschirm.SPINAItemClick(Sender: TObject);
begin
  BringToFront;
end;
