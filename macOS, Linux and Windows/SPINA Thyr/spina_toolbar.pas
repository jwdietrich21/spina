...
type
  ...
  TSPINAToolbar = class(TForm)
    ...
    procedure SPINAItemClick(Sender: TObject);
...
begin
  ...
  begin
    ...
    Hauptschirm.WindowMenu.Caption := kWindow2;
    Hauptschirm.CenterItem.Caption := kCenter2;
    ...
    SPINAToolbar.WindowMenu.Caption := kWindow2;
    SPINAToolbar.CenterItem.Caption := kCenter2;
  ...
  begin
    ...
    SPINAToolbar.HelpMenu.Caption := '?';
    {$ENDIF}
    Hauptschirm.WindowMenu.Caption := kWindow1;
    Hauptschirm.CenterItem.Caption := kCenter1;
    ...
    SPINAToolbar.WindowMenu.Caption := kWindow1;
    SPINAToolbar.CenterItem.Caption := kCenter1;
...
procedure TSPINAToolbar.SPINAItemClick(Sender: TObject);
begin
  Hauptschirm.BringToFront;
end;
...
procedure TSPINAToolbar.CenterItemClick(Sender: TObject);
begin
  Hauptschirm.FormStyle := fsNormal;
  Hauptschirm.WindowState := wsNormal;
  Hauptschirm.Position := poScreenCenter;
  Hauptschirm.Invalidate;
  Hauptschirm.BringToFront;
end;
